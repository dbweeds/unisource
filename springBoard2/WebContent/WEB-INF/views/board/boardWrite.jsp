		...
		$j("input[type='file']").change(function() {
			...
			$j.ajax({
				...
				success: function(result) {
					...
					var str = ""
					str+="<input name='PRDIMG' type='hidden' value='"+result+"'>";
			...
			<td>
				<table border ="1"> 
					<tr>
						...
						<td width="400">
						<select name='PRDGRIDX'>
                        <c:forEach items="${ProductGroupInfo}" var="vo">
							<option value="${vo.PRDGRIDX}">${vo.PRDGRNAME}</option>
						</c:forEach>
                     </select>  
						</td>
					</tr>
					<tr>
						...
						<td width="400">
							<input name="PRDNAME" type="text" size="50"> 
						</td>
					</tr>
					<tr>
						<td width="120" align="center"height="30px">
						...
						<td width="400">
							<input name="PRDPRC" type="text" size="50"> 
						</td>
					</tr>
					<tr>
